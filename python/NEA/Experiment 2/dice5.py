def game():
    ...
    if D1>D2:
        result="Player 1 won "+str(D1)+"/"+str(D2)
        print("Player 1 won "+str(D1)+"/"+str(D2))
    if D1==D2:
        result="Draw "+str(D1)+"/"+str(D2)
        print("Draw "+str(D1)+"/"+str(D2))
    if D1<D2:
        result="Player 2 won "+str(D1)+"/"+str(D2)
        print("Player 2 won "+str(D1)+"/"+str(D2))
...
If you're not registered, log in as 'Guest', or request admin action. """)
    if u=="Guest" or "guest":
        game()
    else:
